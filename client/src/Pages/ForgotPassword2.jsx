        ...
        <div className="min-h-screen flex">
            ...
            <div className="w-1/2 flex items-center justify-center p-10 bg-[#fffdef]">
                <form className="w-full max-w-md space-y-4">
                    <h1 className="text-3xl mb-10 text-left">Enter verification code</h1>

                    <div className="flex flex-col items-start space-y-1">
                        <label className="text-left w-full">Verification code</label>
                        <input 
                            type="email"
                    ...
                    <Link to="/forgot-password-page1" className="-mt-[10px] text-amber-800 hover:text-amber-600">Resend code</Link>
